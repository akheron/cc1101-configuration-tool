...
export const REGISTERS: RegisterDef[] = [
  ...
  },
  {
    ...
    bitFields: [
      ...
      {
        bits: '5:4',
        name: 'CLOSE_IN_RX[1:0]',
        reset: 0,
        rw: 'R/W',
        desc: 'For more details, please see DN010',
      },
      {
        bits: '3:0',
        name: 'FIFO_THR[3:0]',
  ...
  },
  {
    ...
    bitFields: [
      { bits: '7:0', name: 'SYNC[15:8]', reset: 211, rw: 'R/W', desc: '8 MSB of 16-bit sync word' },
    ],
  },
  {
    addr: 0x05,
    ...
    bitFields: [
      { bits: '7:0', name: 'SYNC[7:0]', reset: 145, rw: 'R/W', desc: '8 LSB of 16-bit sync word' },
    ],
  },
  {
    addr: 0x06,
  ...
  },
  {
    ...
    bitFields: [
      ...
      },
      {
        ...
        reset: 0,
        rw: 'R/W',
        desc: 'Controls address check configuration of received packages',
      },
    ],
  },
  {
    ...
    bitFields: [
      ...
      { bits: '3', name: '', reset: 0, rw: 'R', desc: 'Not used' },
      {
        ...
        reset: 1,
        rw: 'R/W',
        desc: '1: CRC calculation in TX and CRC check in RX enabled\n0: CRC disabled for TX and RX',
      },
      {
        bits: '1:0',
        name: 'LENGTH_CONFIG[1:0]',
        reset: 1,
        rw: 'R/W',
        desc: 'Configure the packet length',
      },
    ],
  },
  {
    ...
    bitFields: [
      {
        ...
        reset: 0,
        rw: 'R/W',
        desc: 'The 8-bit unsigned channel number, which is multiplied by the channel spacing setting and added to the base frequency.',
      },
    ],
  },
  {
    ...
    bitFields: [
      {
        ...
        reset: 0,
        rw: 'R',
        desc: 'FREQ[23:22] is always 0 (the FREQ2 register is less than 36 with 26–27 MHz crystal)',
      },
      {
        bits: '5:0',
        name: 'FREQ[21:16]',
  ...
  },
  {
    ...
    bitFields: [
      { bits: '7:0', name: 'FREQ[15:8]', reset: 196, rw: 'R/W', desc: 'Ref. FREQ2 register' },
    ],
  },
  {
    addr: 0x0f,
    ...
    bitFields: [
      { bits: '7:0', name: 'FREQ[7:0]', reset: 236, rw: 'R/W', desc: 'Ref. FREQ2 register' },
    ],
  },
  {
    addr: 0x10,
    ...
    bitFields: [
      ...
      },
      {
        ...
        reset: 12,
        rw: 'R/W',
        desc: 'The exponent of the user-specified symbol rate.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    bitFields: [
      ...
      },
      {
        ...
        reset: 0,
        rw: 'R/W',
        desc: 'The modulation format of the radio signal',
      },
      {
        bits: '3',
        name: 'MANCHESTER_EN',
        reset: 0,
        rw: 'R/W',
        desc: 'Enables Manchester encoding/decoding.\n0 = Disable\n1 = Enable',
      },
      {
        bits: '2:0',
        name: 'SYNC_MODE[2:0]',
  ...
  },
  {
    ...
    bitFields: [
      ...
      {
        bits: '6:4',
        name: 'NUM_PREAMBLE[2:0]',
        reset: 2,
        rw: 'R/W',
        desc: 'Sets the minimum number of preamble bytes to be transmitted.',
      },
      { bits: '3:2', name: '', reset: 0, rw: 'R', desc: 'Not used' },
      {
        ...
        reset: 2,
        rw: 'R/W',
        desc: '2-bit exponent of channel spacing.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    bitFields: [
      { bits: '7:6', name: '', reset: 0, rw: 'R', desc: 'Not used' },
      {
        ...
        reset: 3,
        rw: 'R/W',
        desc: 'Selects CCA_MODE; reflected in CCA signal.',
      },
      {
        bits: '3:2',
        name: 'RXOFF_MODE[1:0]',
      ...
      },
      {
        ...
        reset: 0,
        rw: 'R/W',
        desc: 'Select what should happen after a packet has been sent (TX).',
      },
    ],
  },
  {
    ...
    bitFields: [
      ...
      },
      {
        ...
        reset: 0,
        rw: 'R/W',
        desc: 'Enables the pin radio control option.',
      },
      {
        bits: '0',
        name: 'XOSC_FORCE_ON',
        reset: 0,
        rw: 'R/W',
        desc: 'Force the XOSC to stay on in SLEEP state.',
      },
    ],
  },
  {
    ...
    bitFields: [
      ...
      },
      {
        ...
        reset: 2,
        rw: 'R/W',
        desc: 'Frequency compensation loop gain to be used before a sync word is detected.',
      },
      {
        bits: '2',
        name: 'FOC_POST_K',
  ...
  },
  {
    ...
    bitFields: [
      ...
      },
      {
        ...
        reset: 0,
        rw: 'R/W',
        desc: 'Saturation point for the data rate offset compensation algorithm.',
      },
    ],
  },
  {
    ...
    bitFields: [
      {
        bits: '7:6',
        name: 'MAX_DVGA_GAIN[1:0]',
        reset: 0,
        rw: 'R/W',
        desc: 'Reduces the maximum allowable DVGA gain.',
      },
      {
        bits: '5:3',
        name: 'MAX_LNA_GAIN[2:0]',
        reset: 0,
        rw: 'R/W',
        desc: 'Sets the maximum allowable LNA + LNA 2 gain relative to the maximum possible gain.',
      },
      {
        bits: '2:0',
        name: 'MAGN_TARGET[2:0]',
        reset: 3,
        rw: 'R/W',
        desc: 'Sets the target value for the averaged amplitude from the digital channel filter (1 LSB = 0 dB).',
      },
    ],
  },
  {
    ...
    bitFields: [
      ...
      {
        bits: '5:4',
        name: 'CARRIER_SENSE_REL_THR[1:0]',
        reset: 0,
        rw: 'R/W',
        desc: 'Sets the relative change threshold for asserting carrier sense.',
      },
      {
        bits: '3:0',
    ...
    bitFields: [
      {
        ...
        reset: 2,
        rw: 'R/W',
        desc: 'Sets the level of hysteresis on the magnitude deviation',
      },
      {
        bits: '5:4',
        name: 'WAIT_TIME[1:0]',
        reset: 1,
        rw: 'R/W',
        desc: 'Sets the number of channel filter samples from a gain adjustment',
      },
      {
        bits: '3:2',
        name: 'AGC_FREEZE[1:0]',
        reset: 0,
        rw: 'R/W',
        desc: 'Control when the AGC gain should be frozen',
      },
      {
        bits: '1:0',
        name: 'FILTER_LENGTH[1:0]',
        reset: 1,
        rw: 'R/W',
        desc: 'Sets the averaging length for the amplitude from the channel filter',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    bitFields: [
      ...
      },
      {
        ...
        reset: 1,
        rw: 'R/W',
        desc: 'Enables (1) or disables (0) the RC oscillator calibration.',
      },
  ...
  },
  {
    ...
    bitFields: [
      {
        bits: '7:6',
        name: 'LNA_CURRENT[1:0]',
        reset: 1,
        rw: 'R/W',
        desc: 'Adjusts front-end LNA PTAT current output.',
      },
      {
        bits: '5:4',
        name: 'LNA2MIX_CURRENT[1:0]',
        reset: 1,
        rw: 'R/W',
        desc: 'Adjusts front-end PTAT outputs.',
      },
      {
        bits: '3:2',
        name: 'LODIV_BUF_CURRENT_RX[1:0]',
        reset: 1,
        rw: 'R/W',
        desc: 'Adjusts current in RX LO buffer (LO input to mixer).',
      },
      {
        bits: '1:0',
        name: 'MIX_CURRENT[1:0]',
        reset: 2,
        rw: 'R/W',
        desc: 'Adjusts current in mixer.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    bitFields: [
      ...
      {
        bits: '5:4',
        name: 'CHP_CURR_CAL_EN[1:0]',
        reset: 2,
        rw: 'R/W',
        desc: 'Disable charge pump calibration stage when 0.',
      },
      {
        bits: '3:0',
        name: 'FSCAL3[3:0]',
  ...
  },
  {
    ...
    bitFields: [
      { bits: '7:6', name: '', reset: 0, rw: 'R', desc: 'Not used' },
      {
        ...
        reset: 0,
        rw: 'R/W',
        desc: 'Choose high (1) / low (0) VCO core.',
      },
      {
        bits: '4:0',
        name: 'FSCAL2[4:0]',
  ...
  },
  {
    ...
    bitFields: [
      { bits: '7', name: '', reset: 0, rw: 'R', desc: 'Not used' },
      {
        ...
        reset: 13,
        rw: 'R/W',
        desc: 'Frequency synthesizer calibration control.\nValue provided by SmartRF Studio.',
      },
    ],
  },
  {
    ...
    bitFields: [
      { bits: '7', name: '', reset: 0, rw: 'R', desc: 'Not used' },
      {
        ...
        reset: 65,
        rw: 'R/W',
        desc: 'RC oscillator configuration.',
      },
    ],
  },
  {
    ...
    bitFields: [
      {
        ...
        reset: 89,
        rw: 'R/W',
        desc: 'For test only. Do not write to this register.',
      },
    ],
  },
  {
    ...
    bitFields: [
      {
        ...
        reset: 2,
        rw: 'R/W',
        desc: 'Value provided by SmartRF Studio software.',
      },
      {
        bits: '1',
        name: 'VCO_SEL_CAL_EN',
        reset: 1,
        rw: 'R/W',
        desc: 'Enable VCO selection calibration stage when set to 1.',
      },
      {
        bits: '0',
        name: 'TEST0[0]',
