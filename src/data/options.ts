...
export const PKT_FORMAT_OPTIONS: Option[] = [
  ...
  {
    value: 3,
    desc: 'Asynchronous serial mode; Data in on GDO0 and data out on either of the GDOx pins',
  },
];
...
export const GDO_CFG_OPTIONS: Option[] = [
  ...
  {
    value: 4,
    desc: 'Asserts when the RX FIFO has overflowed. De-asserts when the FIFO has been flushed.',
  },
  {
    value: 5,
    desc: 'Asserts when the TX FIFO has underflowed. De-asserts when the FIFO is flushed.',
  },
  {
    value: 6,
  ...
  {
    value: 7,
    desc: 'Asserts when a packet has been received with CRC OK. De-asserts when the first byte is read from the RX FIFO.',
  },
  {
    value: 8,
  ...
  {
    value: 9,
    desc: 'Clear channel assessment. High when RSSI level is below threshold (dependent on current CCA_MODE setting).',
  },
  {
    value: 10,
  ...
  {
    value: 11,
    desc: 'Serial Clock. Synchronous to the data in synchronous serial mode. In RX mode, data is set up on the falling edge by GDOx_INV=0. In TX mode, data is sampled by GDOx_INV=0 on the rising edge of the serial clock when GDOx_INV=0.',
  },
  ...
  {
    value: 14,
    desc: 'Carrier sense. High if RSSI level is above threshold. Cleared when entering IDLE mode.',
  },
  {
    value: 15,
    desc: 'CRC OK. The last CRC comparison matched. Cleared when entering/restarting RX mode.',
  },
  { value: 16, desc: 'Reserved – used for test' },
  { value: 17, desc: 'Reserved – used for test' },
  {
    value: 18,
    desc: 'RX_HARD_DATA[1]. Can be used together with RX_SYMBOL_TICK for alternative serial RX output.',
  },
  ...
  {
    value: 23,
    desc: 'RX_HARD_DATA[0]. Can be used together with RX_SYMBOL_TICK for alternative serial RX output.',
  },
  ...
  {
    value: 29,
    desc: 'RX_SYMBOL_TICK. Can be used together with RX_HARD_DATA for alternative serial RX output.',
  },
